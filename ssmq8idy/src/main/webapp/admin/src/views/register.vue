<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">新冠肺炎服务预约微信小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='yiyuan'" class="input-group">
			   <div class="label">医院编号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.yiyuanbianhao" class="input" type="text" placeholder="医院编号">
			   </div>
			 </div> -->
			<el-form-item label="医院编号" class="input" v-if="tableName=='yiyuan'">
			  <el-input v-model="ruleForm.yiyuanbianhao" autocomplete="off" placeholder="医院编号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yiyuan'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='yiyuan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='yiyuan'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<!-- <div v-if="tableName=='yiyuan'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.yiyuanmingcheng" class="input" type="text" placeholder="医院名称">
			   </div>
			 </div> -->
			<el-form-item label="医院名称" class="input" v-if="tableName=='yiyuan'">
			  <el-input v-model="ruleForm.yiyuanmingcheng" autocomplete="off" placeholder="医院名称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yiyuan'" class="input-group">
			   <div class="label">医院地址</div>
			   <div class="input-container">
			     <input v-model="ruleForm.yiyuandizhi" class="input" type="text" placeholder="医院地址">
			   </div>
			 </div> -->
			<el-form-item label="医院地址" class="input" v-if="tableName=='yiyuan'">
			  <el-input v-model="ruleForm.yiyuandizhi" autocomplete="off" placeholder="医院地址"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yiyuan'" class="input-group">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='yiyuan'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `yiyuan` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
