      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.yiyuantupian" label="医院图片" prop="yiyuantupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.yiyuantupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
	...
	if(this.ruleForm.yiyuantupian!=null) {
		this.ruleForm.yiyuantupian = this.ruleForm.yiyuantupian.replace(new RegExp(this.$base.url,"g"),"");
	}
