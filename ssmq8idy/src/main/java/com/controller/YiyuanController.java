...
public class YiyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		YiyuanEntity user = yiyuanService.selectOne(new EntityWrapper<YiyuanEntity>().eq("yiyuanbianhao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(user.getId(), username,"yiyuan",  "医院" );
    ...
    public R register(@RequestBody YiyuanEntity yiyuan){
    	...
    	YiyuanEntity user = yiyuanService.selectOne(new EntityWrapper<YiyuanEntity>().eq("yiyuanbianhao", yiyuan.getYiyuanbianhao()));
		if(user!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        YiyuanEntity user = yiyuanService.selectById(id);
